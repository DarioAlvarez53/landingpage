...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full z-50">
      <div>
        <div className="flex flex-row text-white justify-between p-3 lg:px-32 px-5 bg-gradient-to-r from-primary to-backgorundColor shadow[0_3px_10px_rgba(0,0,0,0.2)]">
          {/* Logo */}
