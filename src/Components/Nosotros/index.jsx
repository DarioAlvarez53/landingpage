            ...
            <div className="px-5 lg:px-32 flex flex-col gap-5 lg:flex-row">
                ...
                <div className="h-96 bg-white shadow-xl border border-primary rounded-xl lg:w-1/3 text-primary hover:bg-primary hover:text-white">
                    <div className="flex flex-col justify-center items-center mt-8">
                        ...
                        <p className="px-5 py-1 text-center text-white">Somos una empresa comprometida con el servicio al cliente, ofreciendo servicios integrales de calidad para satisfacer las necesidades de construccion y remodelacion</p>
                    </div>
                </div>
